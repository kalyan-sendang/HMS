...
import com.java.hospitalmanagementsystem.repositories.TokenRepository;
import com.java.hospitalmanagementsystem.repositories.TokenTypeRepository;
...
public class JwtServiceImp implements JwtService {
  ...
  @Override
  public void revokeAllUserTokens(User user, TokenType.TokenTypeEnum tokenType) {
  ...
  @Override
  public void saveUserToken(User user, String jwtToken, TokenType.TokenTypeEnum tokenType) {
    TokenType type =
        tokenTypeRepository
