...
public class BookingController {
   ...
   *
   * @param entertainmentType The entertainment type for the entertainment booking.
   * @param dateFrom         The start date of the booking in the format "yyyy-MM-dd".
   * @param dateTo           The end date of the booking in the format "yyyy-MM-dd".
  ...
  @PreAuthorize("hasAnyRole('ROLE_USER', 'ROLE_ADMIN', 'ROLE_CLEANER', 'ROLE_RESTAURANT')")
  @GetMapping(
      "/entertainment/{entertainmentType}/{dateFrom}/{dateTo}/{timeFrom}/{timeTo}/{entertainmentId}")
        ...
        .body(
            new SuccessResponse<>(
                bookingService.bookEntertainment(
                    entertainmentType, dateFrom, timeFrom, dateTo, timeTo, entertainmentId)));
  }
