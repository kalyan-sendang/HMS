package com.java.hotelmanagementsystem.security;
...
public interface JwtService {
  ...
  void revokeAllUserTokens(User user, TokenType.TokenTypeEnum tokenType);
  ...
  void saveUserToken(User user, String jwtToken, TokenType.TokenTypeEnum tokenType);
